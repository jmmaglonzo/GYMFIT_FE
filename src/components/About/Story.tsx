    ...
    <section className="flex md:space-y-40 space-y-8 text-center md:text-start flex-col container px-4 md:py-20 my-12 md:my-20">
      <div className="flex items-center md:flex-row flex-col">
        ...
        <p className="md:w-1/2 lg:text-xl md:text-base text-sm">
          ...
          envisioned a space where individuals of all fitness levels could come
          together, support one another, and strive for greatness. From humble
          beginnings, we have grown into a thriving fitness community, driven by
          our dedication to helping you succeed.
        </p>
      </div>
      ...
      <div className="flex items-center md:flex-row flex-col">
        ...
        <p className="md:w-1/2 md:order-1 order-2 lg:text-xl md:text-base text-sm">
          ...
          fitness gear. Our spacious and clean environment ensures that you can
          work out comfortably and safely.
        </p>
      </div>
      ...
      <div className="flex items-center md:flex-row flex-col">
        ...
        <p className="md:w-1/2 lg:text-xl md:text-base text-sm">
          At Gym Fit, our team of certified trainers and fitness experts is here
          to guide and motivate you every step of the way. Whether you're a
          beginner or a seasoned athlete, our knowledgeable staff will provide
          personalized training programs, nutritional advice, and ongoing
